...
from aor_cli.commands.grill import grill_cmd
...
Commands: aor init → aor gather|grill → aor spec approve → aor plan → aor run → aor review
...
main.add_command(grill_cmd, name="grill")
main.add_command(grill_cmd, name="discover")
